/*
  RS485HwSerial1.cpp - Hardware serial library for Wiring
...
#endif
{
  RS485HwSerial1._rx_complete_irq();
}
...
#endif
{
  RS485HwSerial1._tx_udr_empty_irq();
}
...
#endif
{
  RS485HwSerial1._tx_complete_irq();
}


RS485HwSerial RS485HwSerial1(&UBRR1H, &UBRR1L, &UCSR1A, &UCSR1B, &UCSR1C, &UDR1);

// Function that can be weakly referenced by serialEventRun to prevent
// pulling in this file if it's not otherwise used.
bool RS485HwSerial1_available() {
  return RS485HwSerial1.available();
}

#endif // HAVE_RS485HWSERIAL1
