/*
  RS485HwSerial_private.h - Hardware serial library for Wiring
...
// RS485HwSerial. constructor also works, but makes the code bigger and
// slower.
#if !defined(TXC0)
#if defined(TXC)
...
#define UDRE0 UDRE1
#else
#error No UART found in RS485HwSerial.cpp
#endif
#endif // !defined TXC0
